...
parser.add_argument('--dvc', type=str, default='cpu', help='running device: cuda or cpu or mps')
...
def main():
    EnvName = ['TrafficControl','LunarLanderContinuous-v2','Humanoid-v4','HalfCheetah-v4','BipedalWalker-v3','BipedalWalkerHardcore-v3']
    BrifEnvName = ['TC', 'LLdV2', 'Humanv4', 'HCv4','BWv3', 'BWHv3']
