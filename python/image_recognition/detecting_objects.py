...
def detecting_the_objects():
    ...
    video_cap = cv2.VideoCapture("python/image_recognition/lkj.mp4")
    writer = create_video_writer(video_cap, "python/image_recognition/output.mp4")

    # Initialize the YOLOv8 model using the default weights
    model = YOLO("python/image_recognition/yolov8s.pt")

    # Initialize the deep sort tracker
    model_filename = "python/image_recognition/config/mars-small128.pb"
    ...
    classes_path = "python/image_recognition/config/coco.names"
    ...
    while True:
        ...
        print("tracker tracks length: ", len(tracker.tracks))
